defmodule GridroomWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GridroomWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GridroomWeb.Gettext, "errors", msg, opts)
    end
  end
